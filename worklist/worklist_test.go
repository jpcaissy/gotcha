...
func TestPredecessors(t *testing.T) {
	...
	allpkgs = false
	_, _ = initSSAandPTA("github.com/jpcaissy/gotcha", src, "../sourcesAndSinks.txt", "")
...
func BenchmarkInitContext(b *testing.B) {
	mainFunc, _ := initSSAandPTA("github.com/jpcaissy/gotcha", src, "../sourcesAndSinks.txt", "")
	for n := 0; n < b.N; n++ {
		initContext(mainFunc)
	}
}
...
func BenchmarkDoAnalysis(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		DoAnalysis("github.com/jpcaissy/gotcha", src, "../sourcesAndSinks.txt", false, "", true)
	}
}
